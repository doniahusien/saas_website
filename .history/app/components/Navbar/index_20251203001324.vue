  ...
  >
    ...
    <div class="flex items-center gap-5">
      <ul class="text-btn flex justify-center items-center gap-3">
        ...
        <li @click.stop="openCart" class="icon relative">
          <Icon name="solar:bag-5-outline" class="size-6" />
          <span
            v-if="cartCount > 0"
            class="absolute -top-1/3 -end-2 bg-btn text-white text-xs font-bold rounded-full min-w-5 h-5 flex items-center justify-center px-1"
          >
