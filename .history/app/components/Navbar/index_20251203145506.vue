    ...
    <div class="flex items-center gap-4">
      <ul class="text-btn flex justify-center items-center gap-3">
        ...
        <li @click.stop="openCart" class="icon ">
          <Icon name="solar:bag-5-outline" class="size-7 image.png" />
          <span
            v-if="cartCount > 0"
            class="absolute  top-4 end-3 bg-btn text-white text-xs font-bold rounded-full size-4 flex items-center justify-center px-1"
          >
