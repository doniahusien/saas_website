<template>
  <transition name="fade">
    <div
      v-if="modelValue"
      class="fixed inset-0 z-50 flex items-center justify-center bg-red-500/60 backdrop-blur-sm"
    >
      <div class="relative bg-light-white flex h-[90vh] w-full max-w-3xl flex-col gap-4 overflow-hidden rounded-2xl p-6 shadow-lg">
        <button
