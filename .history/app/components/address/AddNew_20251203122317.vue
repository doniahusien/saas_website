<template>
  <div class="text-end">
    <button
      v-if="inEdit"
      type="button"
      class="inline-flex items-center justify-center rounded-full bg-gray-100 p-2 hover:bg-gray-200"
      @click="openEdit"
    >
      <Icon name="mynaui:edit-one" class="h-5 w-5 text-third" />
    </button>
    <button
      v-else
      type="button"
      class="base-btn inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold"
      @click="openAddModal"
    >
    ...
    <teleport to="body">
      <div class="relative">
        ...
        >
          ...
          >
            <form
              class="w-100 mx-auto md:max-w-[700px] rounded-2xl bg-white p-5 shadow-sm"
