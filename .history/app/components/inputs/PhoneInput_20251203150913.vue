    ...
    <VeeField :name="codeName" v-model="selectedCode">
      <div class="relative w-24">
        <select
          ...
          @blur="isOpen = false"
          :disabled="disabled"
          class="appearance-none w-full bg-transparent h-14 pb-2 pr-8 font-medium focus:outline-none transition-all disabled:cursor-not-allowed disabled:opacity-60"
          :class="[
            isRes ? 'placeholder:text-black' : 'input',
            errorCode ? 'border-b-2 border-red-500' : 'border-b-2 border-white',
            disabled ? 'text-gray-700 border-b-2 border-gray-200' : 'text-black'
          ]"
        >
          <option
    ...
    <VeeField :name="phoneName" v-model="phoneValue">
      <div class="flex-1 relative">
        <input
          ...
          :disabled="disabled"
          :readonly="disabled"
          class="w-full bg-transparent h-14 font-medium focus:outline-none transition-all disabled:cursor-not-allowed disabled:opacity-60"
          :class="[
            isRes ? 'placeholder:text-black' : 'input',
