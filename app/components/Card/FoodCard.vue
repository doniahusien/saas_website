<template>
  ...
  >
    ...
    <div class="space-y-2 py-4">
      ...
      <p class="text-xs sm:text-sm text-text-light line-clamp-2">
        {{ description }}
      </p>

      <div class="flex justify-between items-center">
        <div class="flex flex-col">
          <span v-if="offer" class="text-sm line-through text-text-light">
            {{ oldPrice }} {{ currency }}
          </span>
        ...
        <div
          v-if="offer"
          class="bg-primary text-sm w-12 h-12 rounded-full text-center flex items-center justify-center text-white p-3"
        >
