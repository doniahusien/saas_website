<template>
  ...
  >
    <div
      class="base-modal-content max-h-160 min-h-75 overflow-y-auto rounded-3xl  relative"
      :class="classes"
      @click.stop
    >
    <div class="p-5 top_header!" v-if="!hideHeader">
      ...
      <div class="my-auto h-full p-4  overflow-x-hidden relative" :class="contentClass">
        <slot />
