<template>
  <div class="container mx-auto space-y-10">
    <div class="flex items-center space-x-4">
      <span class="text-btn">{{ $t("ourStory.eyebrow") }}</span>
      <div class="flex-none w-22 h-px bg-btn"></div>
    </div>

    <h2 class="text-2xl md:text-3xl lg:text-5xl font-bold">Online Reservation</h2>
    ...
    >
      <div class="max-w-2xl mx-auto p-6">
        <div class="text-center mb-6">
          <p class="font-allura text-5xl">reservations</p>
          <h3 class="text-5xl font-bold">Book a Table</h3>
        </div>
